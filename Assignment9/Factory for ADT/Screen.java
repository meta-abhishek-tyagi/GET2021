...
public class Screen {
   ...
   //Add the shape object to the screen 
   static void addShape(Scanner sc){
       System.out.println("Enter name of a Shape :");
    ...
    //takes the input of the parameter of a particular shape type
	...
	while(true){
	    ...
	    System.out.println("5. Sort according to timestamp latest to old");
	...
	System.out.println("\n");
     ...
     //delete shapes from the screen and takes Scanner object as argument
